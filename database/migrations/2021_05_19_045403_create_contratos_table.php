...
class CreateContratosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('contratos', function (Blueprint $table) {
            ...
            $table->decimal('valor_avista', 11,2)->nullable()->default(NULL);
            $table->decimal('valor_parcelado', 11,2)->nullable()->default(NULL);
            $table->bigInteger('quantidade_parcela')->nullable()->default(NULL);
