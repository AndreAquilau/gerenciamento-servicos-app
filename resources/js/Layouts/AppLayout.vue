                            ...
                            <div class="ml-3 relative">
                                <jet-dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <jet-dropdown-link @click="empresaPage()">
                                            Parâmetro/Empresa
                                        </jet-dropdown-link>
                                        <div class="block px-4 py-2 text-xs text-gray-400">
                                        ...
                                        <!-- Team Settings -->
                                        <jet-dropdown-link @click="usuarioPage()">
                                            Usuários Do Sistema
                                        </jet-dropdown-link>
...
import { Inertia } from '@inertiajs/inertia'
    ...
    export default {
        ...
        created() {
            console.log('AppLayout', this.$inertia);
        },
        mounted() {
        },
        methods: {
            ...
            empresaPage() {
                Inertia.get(this.route('empresa'), {
                    empresa_id: this.$inertia.page.props.user.empresa_id,
                    user_id: this.$inertia.page.props.user.id,
                }
                );
            ...
            correntistaPage() {
                Inertia.get(this.route('correntistas'), {
                    empresa_id: this.$inertia.page.props.user.empresa_id,
                    user_id: this.$inertia.page.props.user.id,
                }
                );
            ...
            contratoPage() {
                Inertia.get(this.route('contratos'), {
                    empresa_id: this.$inertia.page.props.user.empresa_id,
                    user_id: this.$inertia.page.props.user.id,
                }
                );
            ...
            usuarioPage() {
                Inertia.get(this.route('usuarios'), {
                    empresa_id: this.$inertia.page.props.user.empresa_id,
                    user_id: this.$inertia.page.props.user.id,
                }
                );
