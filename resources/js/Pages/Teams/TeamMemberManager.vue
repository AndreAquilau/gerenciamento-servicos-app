    ...
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <jet-form-section @submitted="addTeamMember">
                <template #title>
                    Adicionar membro do grupo
                </template>

                <template #description>
                    Adicione um novo membro ao seu grupo, permitindo que eles colaborem com você.
                </template>

                <template #form>
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            Forneça o endereço de e-mail da pessoa que você gostaria de adicionar a este grupo.
                        </div>
                    </div>
                    ...
                    <div class="col-span-6 lg:col-span-4" v-if="availableRoles.length > 0">
                        <jet-label for="roles" value="Regra" />
        ...
        <div v-if="team.team_invitations.length > 0 && userPermissions.canAddTeamMembers">
            ...
            <jet-action-section class="mt-10 sm:mt-0">
                <template #title>
                    Convites pendentes de grupo
                </template>

                <template #description>
                    Essas pessoas foram convidadas para seu grupo e receberam um e-mail de convite. Eles podem se juntar ao grupo aceitando o convite por e-mail.
                </template>
        ...
        <div v-if="team.users.length > 0">
            ...
            <jet-action-section class="mt-10 sm:mt-0">
                ...
                <template #description>
                    Todas as pessoas que fazem parte deste grupo.
                </template>
        ...
        <jet-confirmation-modal :show="confirmingLeavingTeam" @close="confirmingLeavingTeam = false">
            ...
            <template #content>
                Tem certeza de que deseja sair deste time?
            </template>
        ...
        <jet-confirmation-modal :show="teamMemberBeingRemoved" @close="teamMemberBeingRemoved = null">
            ...
            <template #content>
                Tem certeza de que deseja remover esta pessoa do grupo?
            </template>
